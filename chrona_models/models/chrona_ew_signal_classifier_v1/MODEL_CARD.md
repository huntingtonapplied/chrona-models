...
> ⚠️ **Synthetic / non-engine-truth data (`synthetic_iq`).** The metrics below are
> **NOT** the real simulation engine's output — they are computed on the craft's synthetic
> or cited training distribution. The headline number is the **`accuracy_vs_majority`** metric, not an
> engine-faithful accuracy; read it as such.
>
> _Eval note:_ chrona signal_classifier r3 WIN: I/Q corpus 8k->24k, 50 epochs, best-of-4 best-val (s3). §8.8 same-test-set (seed-999 fixed, 800 windows): acc 0.6987->0.7712 (+7.25 pts). Hermetic synthetic I/Q, 8-class.
...
- **Trained:** 2026-07-20T23:11:51.892190+00:00
- **Source checksum (runtime .pt):** `552df38cb242907202e1c07480f7a732c0a55c6d1abc8294de3135b5bca82d3d`
